...
path_input = './models/fs_real_iad.ckpt'  # coco part0

# Output VLMDiff model
output_path = './models/vlmdiff_sd15_model.ckpt'
...
model = create_model(config_path='./models/vlmdiff.yaml')
