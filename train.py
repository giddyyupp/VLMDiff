...
parser.add_argument("--data_set", default='coco', help="choices are coco|realiad|mvtec|visa")
parser.add_argument("--data_path", default='/mnt/isilon/projects/sigcom_cv/shared_datasets/coco')
parser.add_argument("--exp_name", default='coco_part0_scratch', help='checkpoints will be saved inside this folder. make it unique please!')
